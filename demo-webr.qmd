...
webr:
  ...
  repos: ["https://seguid.r-universe.dev", "https://repo.r-wasm.org"]
  packages: ["seguid"]
...
your web browser based on [webR] and [WebAssembly].

To run the examples, click 'Run Code'. Feel free to edit any of them
as you prefer. Nothing you type or enters below leaves your web
