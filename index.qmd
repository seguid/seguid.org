...
protein sequences across databases.  SEGUID v2 [@Pereira_etal_2026]
...
> await seguid.cdseguid("TTGGCATA", "TATGCCAA")
'cdseguid=dUxN7YQyVInv3oDcvz8ByupL44A'

## Same rotating two basepairs (= minimal rotation by Watson)
> await seguid.cdseguid("AATATGCC", "GGCATATT")
'cdseguid=dUxN7YQyVInv3oDcvz8ByupL44A'
```
...
```sh
$ perl seguid --type=cdseguid <<< 'TATGCCAA;TTGGCATA'
cdseguid=dUxN7YQyVInv3oDcvz8ByupL44A

## Same swapping Watson and Crick
$ perl seguid --type=cdseguid <<< 'TTGGCATA;TATGCCAA'
cdseguid=dUxN7YQyVInv3oDcvz8ByupL44A

## Same rotating two basepairs (= minimal rotation by Watson)
$ perl seguid --type=cdseguid <<< 'AATATGCC;GGCATATT'
cdseguid=dUxN7YQyVInv3oDcvz8ByupL44A
```
